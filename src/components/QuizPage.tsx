...
export default function QuizPage({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center md:items-end justify-start md:justify-center p-4 marvel-bg text-[var(--color-text-primary)] pt-12 md:pt-4 overflow-x-hidden">
      ...
      <div className="w-full max-w-[720px] relative mt-4 md:mt-0 md:mr-16 flex flex-col md:block items-center">
        
        {/* Mascot Side-Rail */}
        <div className="md:absolute md:top-1/2 md:-translate-y-1/2 md:right-full md:mr-8 flex flex-col items-center md:items-end z-20 transition-all duration-300 w-max mb-6 md:mb-0">
          ...
          <div className="w-20 h-20 md:w-32 md:h-32 glass-panel-accent rounded-full border-2 border-[var(--color-accent-primary)] overflow-hidden animate-bob shadow-[0_0_20px_rgba(226,54,54,0.4)]">
